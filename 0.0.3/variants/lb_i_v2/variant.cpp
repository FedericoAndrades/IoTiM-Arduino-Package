 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 3          |                  |  PA02  | A0/EXT3_3/DAC   | EIC/EXTINT[2]                   *ADC/AIN[0]  DAC/VOUT  PTC/Y[0]
 * | 4          |                  |  PA03  | A1/EXT3_4       | EIC/EXTINT[3]   [ADC|DAC]/VREFA *ADC/AIN[1]            PTC/Y[1]
 * | 5          |                  |  PB04  | A2/EXT1_9       | EIC/EXTINT[4]  *ADC/AIN[12]  PTC/Y[10]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 6          |                  |  PB05  | EXT1_10         | EIC/EXTINT[5] ADC/AIN[13]  PTC/Y[11]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * | Pin number | Digital I/O      |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 9          |                  |  PB06  | EXT1_5          | EIC/EXTINT[6]  ADC/AIN[14]  PTC/Y[12]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
  { PORTB,  6, PIO_DIGITAL, PIN_ATTR_DIGITAL, ADC_Channel14, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6 },
/*
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | Pin number | Serial1 (RS485)  |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 10         |                  |  PB07  | RS485EX/EXT1_6  | EIC/EXTINT[7]  ADC/AIN[15]  PTC/Y[13
 * | 11         |                  |  PB08  | RS485TX/EXT1_14 | EIC/EXTINT[8] ADC/AIN[2] PTC/Y[14] *SERCOM4_ALT/PAD[0] TC4/WO[0]
 * | 12         |                  |  PB09  | RS485RX/EXT1_13 | EIC/EXTINT[9] ADC/AIN[3] PTC/Y[15] *SERCOM4_ALT/PAD[1] TC4/WO[1]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 13         |                  |  PA04  | MISO/EXT1_17    | EIC/EXTINT[4]  ADC/VREFB  ADC/AIN[4]  AC/AIN[0]  PTC/Y[2] *SERCOM0_ALT/PAD[0]  TCC0/WO[0]
 * | 14         |                  |  PA05  | SS_A/EXT1_15    | EIC/EXTINT[5]             ADC/AIN[5]  AC/AIN[1]  PTC/Y[3] *SERCOM0_ALT/PAD[1]  TCC0/WO[1]
 * | 15         |                  |  PA06  | MOSI/EXT1_16    | EIC/EXTINT[6]             ADC/AIN[6]  AC/AIN[2]  PTC/Y[4] *SERCOM0_ALT/PAD[2]  TCC1/WO[0]
 * | 16         |                  |  PA07  | SCK/EXT1_18     | EIC/EXTINT[7]             ADC/AIN[7]  AC/AIN[3]  PTC/Y[5] *SERCOM0_ALT/PAD[3]  TCC1/WO[1]  I2S/SD[0]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 17         |                  |  PA08  | SDA/EXTx_12     | EIC/NMI        ADC/AIN[16]  PTC/X[0]  SERCOM0/PAD[0] *SERCOM2_ALT/PAD[0]  TCC0/WO[0]  TCC1/WO[2]
 * | 18         |                  |  PA09  | SCL/EXTx_11     | EIC/EXTINT[9]  ADC/AIN[17]  PTC/X[1]  SERCOM0/PAD[1] *SERCOM2_ALT/PAD[1]  TCC0/WO[1]  TCC1/WO[3]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 19         |                  |  PA10  | A3/EXT2_3       | EIC/EXTINT[10] *ADC/AIN[18] PTC/X[2]  SERCOM0/PAD[2] TCC0/WO[2]  TCC1_ALT/WO[0]
 * | 20         |                  |  PA11  | A4/EXT2_4       | EIC/EXTINT[11] *ADC/AIN[19] PTC/X[3]  SERCOM0/PAD[3]  SERCOM2_ALT/PAD[3]  TCC0/WO[3]  TCC1_ALT/WO[1]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * | Pin number | Digital I/O      |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 23         |                  |  PB10  | EXT2_14/EXT3_14 | EIC/EXTINT[10] SERCOM4/PAD[2]  TC5/WO[0]  TCC0/WO[4]  I2S/MCK[1]  GCLK_IO[4]
 * | 24         |                  |  PB11  | EXT2_13/EXT3_13 | EIC/EXTINT[11] SERCOM4/PAD[3]  TC5/WO[1]  TCC0/WO[5]  I2S/SCK[1]  GCLK_IO[5]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 25         |                  |  PB12  | EXT2_7          | EIC/EXTINT[12] PTC/X[12]  SERCOM4/PAD[0] *TC4/WO[0]  TCC0_ALT/WO[6]  I2S/FS[1]  GCLK_IO[6]
 * | 26         |                  |  PB13  | EXT2_8          | EIC/EXTINT[13] PTC/X[13]  SERCOM4/PAD[1] *TC4/WO[1]  TCC0_ALT/WO[7]             GCLK_IO[7]
 * | 27         |                  |  PB14  | EXT2_9          | EIC/EXTINT[14] PTC/X[14]  SERCOM4/PAD[2] *TC5/WO[0]  GCLK_IO[0]
 * | 28         |                  |  PB15  | EXT2_10         | EIC/EXTINT[15] PTC/X[15]  SERCOM4/PAD[3] *TC5/WO[1]  GCLK_IO[1]
 * | 29         |                  |  PA12  | EXT3_7          | EIC/EXTINT[12] SERCOM2/PAD[0]  SERCOM4_ALT/PAD[0] *TCC2/WO[0]  TCC0_ALT/WO[6]  AC/CMP[0]
 * | 30         |                  |  PA13  | EXT3_8          | EIC/EXTINT[13] SERCOM2/PAD[1]  SERCOM4_ALT/PAD[1] *TCC2/WO[1]  TCC0_ALT/WO[7]  AC/CMP[1]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 31         |                  |  PA14  | USB_HOST_ENABLE | USB/VBUS
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * | Pin number | Digital I/O      |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 32         |                  |  PA15  |                 | EXTINT[15] SERCOM2/PAD[3] SERCOM4/PAD[3] TC3/WO[1]  TCC0/WO[5] GCLK_IO[1]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 35         |                  |  PA16  |SPI1_MISO/EXT2_17| EIC/EXTINT[0]  PTC/X[4] *SERCOM1/PAD[0]  SERCOM3_ALT/PAD[0]  TCC2/WO[0]  TCC0_ALT/WO[6]  GCLK_IO[2]
 * | 36         |                  |  PA17  |SPI1_SS_A/EXT2_15| EIC/EXTINT[1]  PTC/X[5] *SERCOM1/PAD[1]  SERCOM3_ALT/PAD[1]  TCC2/WO[1]  TCC0/WO[7]  GCLK_IO[3]
 * | 37         |                  |  PA18  |SPI1_MOSI/EXT2_16| EIC/EXTINT[2]  PTC/X[6] *SERCOM1/PAD[2]  SERCOM3_ALT/PAD[2]  TC3/WO[0]  TCC0_ALT/WO[2]  AC/CMP[0]
 * | 38         |                  |  PA19  |SPI1_SCK/EXT2_18 | EIC/EXTINT[3]  PTC/X[7] *SERCOM1/PAD[3]  SERCOM3_ALT/PAD[3]  TC3/WO[1]  TCC0_ALT/WO[3]  I2S/SD[0]  AC/CMP[1]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 39         |                  |  PB16  |Serial2TX/EXT3_17| EIC/EXTINT[0] *SERCOM5/PAD[0] TC6/WO[0]  TCC0_ALT/WO[4]  I2S/SD[1]  GCLK_IO[2]
 * | 40         |                  |  PB17  |Serial2RX/EXT3_15| EIC/EXTINT[1] *SERCOM5/PAD[1] TC6/WO[1]  TCC0_ALT/WO[5]  I2S/MCK[0]  GCLK_IO[3]
 * | 41         |                  |  PA20  |Serial2EX/EXT2_5 | EIC/EXTINT[4]  PTC/X[8]  SERCOM5/PAD[2]  SERCOM3_ALT/PAD[2]  TC7/WO[0]  TCC0_ALT/WO[6]  I2S/SCK[0]  GCLK_IO[4]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 42         | RN2903           |  PA21  | RN_RST/EXT2_6   | EIC/EXTINT[5]  PTC/X[9]  SERCOM5/PAD[3]  SERCOM3_ALT/PAD[3]  TC7/WO[1]  TCC0_ALT/WO[7]  I2S/FS[0]  GCLK_IO[5]
 * | 43         | RN2903           |  PA22  | RN_TX /EDBG/TX  | EIC/EXTINT[6]  PTC/X[10] *SERCOM3/PAD[0]  SERCOM5_ALT/PAD[0]  TC4/WO[0]  TCC0_ALT/WO[4]
 * | 44         | RN2903           |  PA23  | RN_RX /EDBG/RX  | EIC/EXTINT[7]  PTC/X[11] *SERCOM3/PAD[1]  SERCOM5_ALT/PAD[1]  TC4/WO[1]  TCC0_ALT/WO[5]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * | Pin number | Digital I/O      |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 49         |                  |  PB22  | EXT3_16         | EIC/EXTINT[6] SERCOM5_ALT/PAD[2] TC7/WO[0] GCLK_IO[0]
 * | 50         |                  |  PB23  | SCK/EXT3_18     | EIC/EXTINT[7] SERCOM5_ALT/PAD[3] TC7/WO[1] GCLK_IO[1]
 * | 51         | UserSwitch       |  PA27  | SW_USER/EXT3_10 | EIC/EXTINT[15]  GCLK_IO[0]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
*/
 ...
 * | Pin number | Digital I/O      |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 53         |                  |  PA28  | EXT3_9          | EIC/EXTINT[8]  GCLK_IO[0]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
*/
 ...
 * | Pin number | Digital I/O      |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 59         | Led Red          |  PB30  | LED0            | EXTINT[14] SERCOM5/PAD[0] TCC0/WO[0] TCC1/WO[2]
 * | 60         | Led Blue         |  PB31  | LED1            | EXTINT[14] SERCOM5/PAD[0] TCC0/WO[0] TCC1/WO[2]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
*/
 ...
 * | Pin number | Analog pins      |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 61         |                  |  PB00  | A5/EXT1_3       | EIC/EXTINT[0]                   *ADC/AIN[8]            PTC/Y[6]                  SERCOM5_ALT/PAD[2]  TC7/WO[0]
 * | 62         |                  |  PB01  | A6/EXT1_4       | EIC/EXTINT[1]                   *ADC/AIN[9]            PTC/Y[7]                  SERCOM5_ALT/PAD[3]  TC7/WO[1]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * | Pin number | Digital/PWM      |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 63         |                  |  PB02  | EXT1_7          | EIC/EXTINT[2]  ADC/AIN[10]  PTC/Y[8]  SERCOM5_ALT/PAD[0] *TC6/WO[0]
 * | 64         |                  |  PB03  | EXT1_8          | EIC/EXTINT[3]  ADC/AIN[11]  PTC/Y[9]  SERCOM5_ALT/PAD[1] *TC6/WO[1]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
...
Uart SerialRN( &sercom3, PIN_SERIALRN_RX, PIN_SERIALRN_TX, PAD_SERIALRN_RX, PAD_SERIALRN_TX ) ;
